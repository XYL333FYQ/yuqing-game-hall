...
export function siteHeader(..._args: unknown[]): string { return `<header class="game-header"><a href="${fruitPartyHref("home")}" data-game-nav>🍉 果切派对</a><span>独立游戏</span></header>`; }
export function siteFooter(): string { return `<footer class="game-footer">果切派对 · 独立静态游戏</footer>`; }
