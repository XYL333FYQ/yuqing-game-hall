...
(function() {
  var $, a, defaultControls, defaultQuality, getWebGL, hasWebGL, init, s, u, _fn, _i, _len;
  ...
  defaultQuality = (function() {
    var canvas = document.createElement('canvas'), gl, ext, label = '';
    try {
    ...
    if (/swiftshader|llvmpipe|software/i.test(label)) return 1;
